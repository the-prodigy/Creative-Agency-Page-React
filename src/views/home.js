      ...
      <main className="home-main">
        ...
        <div className="section-container">
          <div className="home-max-width2 max-content-container">
            ...
            <div className="home-tab-selector-header">
              ...
              <Link to="/test" className="home-navlink tab-selector-btn">
                Branding
              </Link>
              <span className="home-text21 tab-selector-btn">UI / UX</span>
              <span className="home-text22 tab-selector-btn">Packaging</span>
        ...
        <div className="home-about section-container">
          <div className="home-max-width3 max-content-container">
            <div className="home-text-container2">
              <span className="home-text24">about us</span>
        ...
        <div className="home-process section-container">
          <div className="home-max-width4 max-content-container">
            ...
            <div className="home-step">
              <span className="home-text41">01</span>
              <div className="home-container5">
                <span className="home-text42">Finding the best idea</span>
            ...
            <div className="home-step2">
              <span className="home-text47">03</span>
              <div className="home-container7">
                <span className="home-text48">Strong design execution</span>
        ...
        <div className="section-container">
          <div className="home-max-width5 max-content-container">
            <span className="home-text50">from blog</span>
            <h2 className="home-text51 heading2">
        ...
        <div className="home-banner section-container">
          <div className="home-max-width6 max-content-container">
            <span className="home-text57">what are you waiting?</span>
      ...
      <div className="section-container">
          ...
          <div className="home-top-part">
            <div className="home-links-container">
              <div className="home-product-container">
                <span className="home-text64">Product</span>
                <span className="home-text65">About</span>
                <span className="home-text66">Portofolio</span>
                <span>Blog</span>
              </div>
              <div className="home-navigate-container">
                <span className="home-text68">Navigate</span>
                <span className="home-text69">Copyrights</span>
                <span className="home-text70">Sitemap</span>
            ...
            <div className="home-subscribe-container">
              <span className="home-text81">Subscribe to our newsletter</span>
              <input
                type="text"
        ...
        <footer className="home-max-width8 max-content-container">
          ...
          <span className="home-text82">
            ...
            <span className="home-text86">teleporhq.io</span>
            <span>
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
